...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar px-4 py-2 fixed w-full z-40 lg:block border-gray-200 backdrop-blur-xs">
        ...
        <AnimatePresence>
          {isShow && (
            <motion.div
              ...
              className={
                isShow
                  ? `flex flex-col gap-4 w-full items-start shadow-sm py-10 bg-white absolute top-14 left-0 right-0 -z-10`
                  : `hidden`
              }
            >
        ...
        <div className="hidden md:flex md:items-center md:justify-between md:px-2 md:py-4 lg:px-14 xl:px-30">
          ...
          <div className="flex md:gap-10 lg:gap-14">
            ...
            <NavLink
              to={"/registration"}
              className={"nav-link hover:text-primary-color font-medium"}
            >
              Signup
            </NavLink>
          </div>
