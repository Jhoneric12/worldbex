    ...
    <section className="xl:px-36 xl:pt-12 xl:h-screen xl:overflow-hidden xl:grid xl:grid-cols-4 xl:grid-rows-3 lg:gap-4">
      <div className="md:justify-center xl:justify-start xl:col-span-2 xl:h-full xl:row-span-2 xl:mt-16 px-8 flex flex-col justify-between min-h-screen">
        <div className="flex flex-col gap-4">
          <img
            src={HeaderLogo}
            className="py-8 xl:hidden pt-20 md:hidden"
            alt="WorldBex Logo"
          />
          <h1
      ...
      <div className="p-8 xl:p-0 xl:col-span-2 xl:col-start-1 xl:row-start-3">
        ...
        <h1 className="text-gray-500 text-center p-4 lg:p-2 lg:text-sm">
          Organizer Of
        </h1>
          ...
          {organizers.map((org, index) => (
            <div key={index} className="p-2 shrink-0 md:shrink-1">
              <img
                ...
                alt={org.alt}
                loading="lazy"
                className="hover:scale-150 duration-300 xl:max-w-[40px]"
              />
            </div>
          ))}
        </div>
